<div id="content" class="clearfix">
    <div class="contentwrapper"><!--Content wrapper-->
        ...
        <div class="heading">
            ...
            <h3>Select Category For Photo</h3>                    
            ...
            <div class="span12">
                ...
                <div class="box">
                    ...
                    <div class="title">
                        ...
                        <h4>
                            <span>Select Category For Photo</span>
                        </h4>
                        <?php echo $this->Session->flash(); ?> 
                    </div>
                    <div class="content">
                        <?php
                        echo $this->Form->create('Photogallery', array(
                            'inputDefaults' => array(
                                'label' => false,
                                'div' => false
                            ),
                        ...
                        <div class="form-row row-fluid">
                            <div class="span12">
                                <div class="row-fluid">
                                    <label class="form-label span3" for="required">Category Name</label>
                                    <?php
