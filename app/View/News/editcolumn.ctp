        ...
        <div class="row-fluid">
            <div class="span12">
                <div class="box">
                    ...
                    <div class="content">
                        <?php
                        echo $this->Form->create('Column', array(
                            'inputDefaults' => array(
                                'label' => false,
                                'div' => false
                            ),
                        ...
                        <div class="form-row row-fluid">
                            <div class="span12">
                                <div class="row-fluid">
                                    <label class="form-label span3" for="required">Column Name</label>
                                    <?php
                        ...
                        <div class="form-row row-fluid">
                            <div class="span12">
                                <div class="row-fluid">
                                    <label class="form-label span3" for="required">New Column Name</label>
